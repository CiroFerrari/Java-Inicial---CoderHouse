...
public interface InvoiceRepository extends JpaRepository<Invoice, Integer> {
  // Para un inner join, generamos una nueva entidad DTO, que es muy similar a la
  // entidad
  // solamente que no instancia nuevos registros, sino que simplemente genera un
  // objeto de transferencia de datos
  // DTO
  @Query("SELECT new com.ferrari.FacturacionEntrega.model.InvoiceDTO(" +
      "i.id invoice_id, " +
      "i.created_at, " +
      "i.total" +
