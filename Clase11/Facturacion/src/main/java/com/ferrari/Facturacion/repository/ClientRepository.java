...
public interface ClientRepository extends JpaRepository<Client, Integer> {
  ...
  // Como estamos haciendo nativeQuery, debemos llamar al nombre de la tabla tal
  // cual está en la db
  ...
  // Difiere JPQL de SQL normal, simplemente llamamos a INNER JOIN pero no
  // especificamos las claves
